...
'''I am very interested in Dungeons and Dragons and how characters are created. 
I wanted to make a tool that could be used by Dungeon Masters(DMs) and Players 
alike to make both random Non Player Characters(NPCs) and Player Characters(PCs).
This tool would allow quick making of characters and help to inspire PC creativity.'''
...
DwarfSubrace = ('Hill Dwarf', 'Gray Dwarf (Duergar)', 'Mountain Dwarf') #3 Items
ElfSubrace = ('Air Elf (Avariel)', 'Dark Elf (Drow)', 'Deep-Forest Elf (Grugach)', 'Fey Elf (Eladrin)', 'Half-Elf', 'High Elf', 'Sea Elf', 'Shadowfell Elf (Shadar-kai)', 'Wood Elf') #9 items
...
''' COLLECTS AND DISPLAYS THE DATA FROM THE MESSAGE BOXES '''        
def display_dndrc1():
    final1 = retrieve_dndrc1()
    tkinter.messagebox.showinfo('Your Character is a...', message = final1)    
def retrieve_dndrc1():
    return dndrc_Overview()
# 
def display_dndrc2():
    final2 = retrieve_dndrc2()
    tkinter.messagebox.showinfo('Your Character is a...', message = final2)    
def retrieve_dndrc2():
    return dndrc_Gender()
# 
def display_dndrc3():
    final3 = retrieve_dndrc3()
    tkinter.messagebox.showinfo('Your Character is a(n)...', message = final3)    
def retrieve_dndrc3():
    return dndrc_Subr()
# 
def display_dndrc4():
    final4 = retrieve_dndrc4()
    tkinter.messagebox.showinfo('Your Character is a(n)...', message = final4)  
def retrieve_dndrc4():
    return dndrc_Subc()
...
text.pack()
# 
Button1 = Button(root, width = 20, text='Random Character', command = display_dndrc1)
Button1.pack()
# 
Button2 = Button(root, width = 20, text='Random Gender', command = display_dndrc2)
Button2.pack()
# 
Button3 = Button(root, width = 20, text='Random Race & Subrace', command = display_dndrc3)
Button3.pack()
# 
Button4 = Button(root, width = 20, text='Random Class & Subclass', command = display_dndrc4)
Button4.pack()
# 
root.title('AutoGen')
